...
export const EDU_DATA: Record<LevelId, EduData> = {
  ...
  taxonomy: {
    title: "《初始台地：獵人的科學視野》",
    text: "恭喜完成初始台地的試煉！<br><br>1. <b>植物分類</b>：原住民的分類學基於「功能」與「棲地」，對應生態區位。<br>2. <b>穀倉結構</b>：防鼠板利用靜摩擦力與斜面原理，是精密的力學設計。<br>3. <b>研究提問</b>：好的科學始於對傳統智慧的好奇。將「阿嬤說的話」轉化為「可驗證的變因」，就是科展的第一步。<br><br><span class='text-amber-400'>現在，請前往<b>大地神殿 (Dye)</b>，那裡隱藏著關於「色彩與化學」的古老秘密...</span>"
  },
  trap: {
